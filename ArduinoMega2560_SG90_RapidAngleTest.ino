/*
 * =====================================================
 *  Arduino Mega 2560 + SG90 — Rapid Angle Change Test
 *
 *  Wiring:
 ...
 *    SG90 GND    (Brown)  --> GND
 *
 *  PWM-capable pins on Mega: 2–13, 44, 45, 46
 *  Library: Built-in <Servo.h> (no install needed)
 *  Note: Mega supports up to 48 simultaneous servos
 * =====================================================
 */
#include <Servo.h>
...
void setup() {
  ...
  Serial.println("SG90 Rapid Angle Test — Arduino Mega 2560");
  sg90.write(90);
  delay(1000);
}
